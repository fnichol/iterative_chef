...
default[:nginx][:tar_checksum] = "2feb0acee473cc360a620ee862907b9570a4121956c40cbd27da35f5b0a96045"

default[:nginx][:packages] = %w{ build-essential binutils-doc autoconf flex bison
